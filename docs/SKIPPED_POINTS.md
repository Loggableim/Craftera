...
| AP | Grund | Datum | Nötig für Bearbeitung |
|----|-------|-------|------------------------|
| AP-7.10 … AP-7.11 | Die Play-Modi-APs der Phase 7 (außer AP-7.3 bis AP-7.9, die erledigt sind) benötigen eine installierte Godot-Runtime zur realen Verifikation ("Buttons wirken", "Package läuft"). Ohne Godot (AP-7.1 übersprungen) ist keine reale Verifikation möglich. | 2026-08-12 | Godot 4.x installieren und in den PATH aufnehmen. Danach AP-7.10 bis AP-7.11 bearbeiten. |
