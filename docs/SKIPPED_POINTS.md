...
| AP | Grund | Datum | Nötig für Bearbeitung |
|----|-------|-------|------------------------|
| AP-7.6 … AP-7.11 | Die GodotAdapter-/Compiler-/Bridge-/Builder-APs der Phase 7 (außer AP-7.3, AP-7.4 und AP-7.5, die erledigt sind) benötigen eine installierte Godot-Runtime zur realen Verifikation ("Godot zeigt/startet"). Ohne Godot (AP-7.1 übersprungen) ist keine reale Verifikation möglich. | 2026-08-12 | Godot 4.x installieren und in den PATH aufnehmen. Danach AP-7.6 bis AP-7.11 bearbeiten. |
